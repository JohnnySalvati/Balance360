...
from balance360.crud.category import (
    create,
    delete,
    get_all,
    get_by_id,
...
from balance360.schemas.category import CategoryCreate, CategoryRead, CategoryUpdate
...
def delete_category(
    category: Category = Depends(get_category_or_404), db: Session = Depends(get_db)
):
    delete(db, category)
