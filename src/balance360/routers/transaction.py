...
from balance360.crud.transaction import create, delete, get_all, get_by_id, update
from balance360.dependencies import get_db
from balance360.enums import TransactionType
from balance360.models.transaction import Transaction
from balance360.schemas.transaction import (
    TransactionCreate,
    TransactionRead,
    TransactionUpdate,
)
...
def delete_transaction(
    transaction: Transaction = Depends(get_transaction_or_404), db: Session = Depends(get_db)
):
