...
from balance360.crud.exchange_rate import create, delete, get_all, get_by_id, update
from balance360.dependencies import get_db
from balance360.models.exchange_rate import ExchangeRate
from balance360.schemas.exchange_rate import (
    ExchangeRateCreate,
    ExchangeRateRead,
    ExchangeRateUpdate,
)
...
def get_exchange_rate_or_404(
    exchange_rate_id: uuid.UUID, db: Session = Depends(get_db)
) -> ExchangeRate:
...
def delete_exchange_rate(
    exchange_rate: ExchangeRate = Depends(get_exchange_rate_or_404), db: Session = Depends(get_db)
):
...
def update_exchange_rate(
    ...
    exchange_rate: ExchangeRate = Depends(get_exchange_rate_or_404),
