...
from balance360.crud.user import create, delete, get_all, get_by_id, update
from balance360.dependencies import get_db
from balance360.models.user import User
from balance360.schemas.user import UserCreate, UserRead, UserUpdate
...
def update_user(
    data: UserUpdate, user: User = Depends(get_user_or_404), db: Session = Depends(get_db)
):
