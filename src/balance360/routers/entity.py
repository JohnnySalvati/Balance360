...
from balance360.crud.entity import create, delete, get_all, get_by_id, update
from balance360.dependencies import get_db
from balance360.models.entity import Entity
from balance360.schemas.entity import EntityCreate, EntityRead, EntityUpdate
...
def update_entity(
    data: EntityUpdate, entity: Entity = Depends(get_entity_or_404), db: Session = Depends(get_db)
):
