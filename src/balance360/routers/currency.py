...
from balance360.crud.currency import (
    create,
    delete,
    get_all,
    get_by_id,
...
from balance360.schemas.currency import CurrencyCreate, CurrencyRead, CurrencyUpdate
...
def delete_currency(
    currency: Currency = Depends(get_currency_or_404), db: Session = Depends(get_db)
):
    delete(db, currency)
