...
from balance360.reports import get_account_balances, get_monthly_income_expense, get_expenses_by_category
...
def expenses_by_category(
    ...
    by_category = get_expenses_by_category(db, year=year, month=month, limit=6, entity_ids=entity_ids)
